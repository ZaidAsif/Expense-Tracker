...
export default function Login() {
  ...
  <body style={{backgroundColor: '#00bfa1'}}>
    ...
    >
      <h1 style={{ color: '#fff', fontSize: '30px', backgroundColor: '#00a288', height: '70px', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Login</h1>
      <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          columnGap: '50%',
      ...
      <TextField id="standard-basic" label="Password" variant="standard" type="password" value={password} onChange={(e) => { setPassword(e.target.value) }} />
                ...
                <Button variant="contained" style={{backgroundColor: '#00a188'}} onClick={() => {handleLogin()}}>Login</Button>
                <br />
                <button style={{color: '#2fb7a4', textDecoration: 'underline'}} onClick={() =>  router.push('/')}>Dont have an account! Signup here</button>
                </div>
            </Container>
            </body>
        </>
